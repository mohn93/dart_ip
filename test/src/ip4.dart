  ...
  group('Ipv4Packet', () {
    ...
    group('example #1', () {
      ...
      test('decoded properties', () {
        ...
        expect(decoded.options, selfEncoderEqualsBytes([7, 8, 9, 0], format: DebugHexEncoder()));
        expect(decoded.payload, selfEncoderEqualsBytes([1, 2, 3], format: DebugHexEncoder()));
      });
    });
  });
}
